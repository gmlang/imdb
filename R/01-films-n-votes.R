...
plot_films_n_votes = function() {
        ...
        p = ezplot::add_labs(p, ylab = "Count", xlab = NULL, subtitle = NULL,
        ...
        p = ezplot::add_labs(
                p, ylab = "Votes per film", xlab = NULL, subtitle = NULL,
        ...
        p = plt("year_cat", "films", linew = 1.2, pt_size = 3)
        p = ezplot::add_labs(p, ylab = "Count", xlab = NULL, subtitle = NULL,
                             title = "Number of films (1913 - 2014)")
        p = ezplot::web_display(p)
        print(p)
        ...
        p = plt("year_cat", "votes", linew = 1.2, pt_size = 3)
        p = ezplot::add_labs(p, ylab = "Count", xlab = NULL, subtitle = NULL,
                             title = "Number of votes (1913 - 2014)")
        p = ezplot::scale_axis(p, scale = "log10")
        p = ezplot::web_display(p)
        ...
        p = plt("year_cat", "avg_votes", linew = 1.2, pt_size = 3)
        p = ezplot::add_labs(
                p, ylab = "Votes per film", xlab = NULL, subtitle = NULL,
                title = "Average votes per film (1913 - 2014)")
        p = ezplot::scale_axis(p, scale = "log10")
